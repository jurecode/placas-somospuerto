...
export function dibujar(ctx, datos, fotos, ancho, marca = {}){
  ...
  /* Las fotos llenan el cuadro. Las imágenes llegan con las claves cortas
     ...
     el círculo encima. Acá no hay recuadro con márgenes como allá: la foto va
     a sangre, así que dos fotos son las dos mitades del cuadro. */
  ...
  /* El círculo recortado, con su anillo blanco. Va sobre el degradado no:
     va antes, para que el fundido lo alcance igual que a las fotos y no
     quede flotando por encima de todo. */
